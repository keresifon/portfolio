		...
		<div className="alert border">
			<CardGroup>
				<div className="container">
					<Card className="bg-dark text-red">
						<Card.Img
							src="https://res.cloudinary.com/kwesiblack/image/upload/v1599143587/portfolio/blue-3329498_640_kckgys.png"
							alt="Card image"
							className="image"
						/>
						<Card.ImgOverlay>
				...
				<div className="container">
					<Card className="bg-dark text-red">
						<Card.Img
							src="https://res.cloudinary.com/kwesiblack/image/upload/v1599143903/portfolio/robot-507811_640_my5cmy.jpg"
							alt="Card image"
			...
			<CardGroup>
				<div className="container">
					<Card className="bg-dark text-red">
						<Card.Img
							src="https://res.cloudinary.com/kwesiblack/image/upload/v1599144607/portfolio/writing-3374234_640_xnsxz0.jpg"
							alt="Card image"
							className="image"
						/>
						<Card.ImgOverlay>
				...
				<div className="container">
					<Card className="bg-dark text-red">
						<Card.Img
							src="https://res.cloudinary.com/kwesiblack/image/upload/v1599145319/portfolio/IMG_7330-2_hfjmfw.jpg"
							alt="Card image"
							className="image fluid"
						/>
						<Card.ImgOverlay>
